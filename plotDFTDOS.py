...
def plot_dos(
    ...
    atoms_d = [
        *np.arange(
            sum(species_count[: b_index - 1]),
            sum(species_count[: b_index - 1]) + species_count[b_index - 1],
        )
    ]
    if atoms:
    ...
    if degenerate:
        ...
        _, ax3 = pyprocar.dosplot(
            ...
            atoms=[
                *np.arange(
                    sum(species_count[:b_index]),
                    sum(species_count[:b_index]) + species_count[b_index],
                )
            ],
            plot_total=False,
            plt_show=False,
        ...
        if not sp:
            ...
            ax.plot(
                x1,
                y1_up,
                label=species[b_index - 1] + r"-d$_{t2g} \uparrow$",
                color="blue",
            )
            ax.plot(
                x1,
            ...
            ax.plot(
                x2,
                y2_up,
                label=species[b_index - 1] + r"-d$_{eg} \uparrow$",
                color="red",
            )
            ax.plot(
                x2,
    ...
    # Non-degenerate case
        ...
        if not sp:
            ...
            ax.plot(
                x5, y5, label=species[b_index - 1] + "-d$_{x^2-y^2}$", color="maroon"
            )
            if oxygen:
            ...
            ax.plot(
                x1,
                y1_up,
                label=species[b_index - 1] + r"-d$_{xy} \uparrow$",
                color="blue",
            )
            ax.plot(
                x1,
            ...
            ax.plot(
                x2,
                y2_up,
                label=species[b_index - 1] + r"-d$_{yz} \uparrow$",
                color="cyan",
            )
            ax.plot(
                x2,
            ...
            ax.plot(
                x3,
                y3_up,
                label=species[b_index - 1] + r"-d$_{xz} \uparrow$",
                color="lightblue",
            )
            ax.plot(
                x3,
            ...
            ax.plot(
                x4,
                y4_up,
                label=species[b_index - 1] + r"-d$_{z^2} \uparrow$",
                color="red",
            )
            ax.plot(
                x4,
            ...
            ax.plot(
                x5,
                y5_up,
                label=species[b_index - 1] + r"-d$_{x^2-y^2} \uparrow$",
                color="maroon",
            )
            ax.plot(
                x5,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        ...
        "--b_index",
        type=int,
        help="The index of the B species in POSCAR. Default is 2 assuming ABO3 structure.",
        default=2,
    )
    parser.add_argument(
        "-d",
